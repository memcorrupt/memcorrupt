## Hey :wave:! I'm memcorrupt!

### :rocket: Introduction

You may be familiar with my username from various projects created throughout my teenage years that have consisted of:

- creating free and useful addons for online websites
- useful modifications or addons for games such as Minecraft and Roblox 
...
*This is not an exhaustive list and only contains technologies that I am proficient with **and** have recently worked with. ([thanks to this repository for badges!](https://github.com/Ileriayo/markdown-badges))*

### :calling: Contact

The authorative source of my current Discord account can be found [here](https://mem.rip/discord.txt "memcorrupt's discord account").

Alternatively, you can reach me via email at [mem@mem.rip](mailto:mem@mem.rip). Please be direct and concise, as I get a relatively large volume of email at this address. :pray:
